...
CREATE TABLE `project_members` (
  ...
  `role_in_project` enum('SCRUM_MASTER','DEVELOPER','TESTER','PO','MEMBER') DEFAULT 'MEMBER',
...
INSERT INTO `project_members` VALUES (1,5,'SCRUM_MASTER'),(1,6,'DEVELOPER'),(1,7,'DEVELOPER'),(1,8,'DEVELOPER'),(1,9,'DEVELOPER');
